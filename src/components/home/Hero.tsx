  ...
  return (
    <div className="relative isolate px-6 lg:px-8 h-screen">
      <div
        ...
        aria-hidden="true"
      >
        <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] "></div>
      </div>
