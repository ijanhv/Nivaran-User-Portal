  ...
  return (
    <PortalLayout>
      <div className="max-w-7xl mx-auto mt-10 px-10 sm:px-1">
        ...
        your grievance. शिकायत दर्ज करने के लिए, कृपया नीचे दिए गए सभी क्षेत्रों
        को सटीकता से भरें। कृपया सुनिश्चित करें कि आप फ़ॉर्म को सही ढंग से भरें,
        क्योंकि आपके द्वारा प्रदान की गई जानकारी आपकी शिकायत की आगामी प्रक्रिया
